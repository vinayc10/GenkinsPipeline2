...
Response response;
	...
	String empAge=RestUtils.empAge();
	 ...
	 Logger log2=LogManager.getLogger(TC003_POST_Employee_Record.class.getName());
	@BeforeClass
	void createEmployee() throws Exception {
		log2.info("---------Started TC003_POST_Employee_Record--------");
		// Specify baseURI
	...
	void tearDown()
	{
		log2.info("---------Finished TC003_POST_Employee_Record--------");
	}
}
